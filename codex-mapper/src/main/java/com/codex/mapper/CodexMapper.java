...
import com.codex.mapper.flex.CodexEntitySqlProvider;
...
public interface CodexMapper {
    ...
    <T> int insert(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.ENTITY) T entity, @Param(FlexConsts.IGNORE_NULLS) boolean ignoreNulls);
    ...
    <T> int insertWithPk(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.ENTITY) T entity, @Param(FlexConsts.IGNORE_NULLS) boolean ignoreNulls);
    ...
    <T> int insertBatch(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.ENTITIES) List<T> entities);
    ...
    <T> int deleteById(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.PRIMARY_VALUE) Serializable id);
    ...
    <T> int deleteBatchByIds(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.PRIMARY_VALUE) Collection<? extends Serializable> ids);
    ...
    <T> int deleteByQuery(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.QUERY) QueryWrapper queryWrapper);
    ...
    <T> int update(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.ENTITY) T entity, @Param(FlexConsts.IGNORE_NULLS) boolean ignoreNulls);
    ...
    <T> int updateByQuery(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.ENTITY) T entity, @Param(FlexConsts.IGNORE_NULLS) boolean ignoreNulls, @Param(FlexConsts.QUERY) QueryWrapper queryWrapper);
    ...
    <T> T selectOneById(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.PRIMARY_VALUE) Serializable id);
    ...
    <T> List<T> selectListByIds(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.PRIMARY_VALUE) Collection<? extends Serializable> ids);
    ...
    <T> List<T> selectListByQuery(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.QUERY) QueryWrapper queryWrapper);
     ...
     */
    @SelectProvider(type = CodexEntitySqlProvider.class, method = "selectListByQuery")
    <T> List<Row> selectRowsByQuery(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.QUERY) QueryWrapper queryWrapper);
    ...
    <T> List<Object> selectObjectListByQuery(@Param(CodexMapperConstants.CLASS) Class<T> codexClass, @Param(FlexConsts.QUERY) QueryWrapper queryWrapper);
