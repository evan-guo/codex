...
public class UserLoginServiceImpl implements LoginService {
    ...
    public String login(UserLoginForm form) {
        ...
        DateTime expireTime = now.offsetNew(DateField.MINUTE, (int) loginTokenProperties.getDuration().toMinutes());
        // 签发时间
        ...
        boolean verify = jwt.setKey(loginTokenProperties.getSecret().getBytes()).verify();
